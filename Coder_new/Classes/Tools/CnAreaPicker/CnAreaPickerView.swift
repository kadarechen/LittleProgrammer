...
public class CnAreaPickerView: UIView {
    ...
    public static func picker<controller: UIViewController>(for controller: controller, textField: UITextField, barTintColor: UIColor = UIColor.systemRed, tintColor: UIColor = UIColor.systemBlue, areaLevel: Int = 3) -> CnAreaPickerView where controller: CnAreaPickerDelegate {
