...
class OrderViewController1: UIViewController,UITableViewDataSource, UITableViewDelegate {
    
    
    lazy var teachers:[stuteacher] = {
        var teachers = [stuteacher(image: "teaPro_01.JPG", school: "四川大学", name: "Wisk老师", gender: "男", old: "20岁", major: "计算机科学", degree: "研究生", teaOld: "37", price: "100"),stuteacher(image: "teaPro_02.JPG", school: "四川农业大学", name: "许老师", gender: "女", old: "20岁", major: "计算机科学", degree: "研究生", teaOld: "37", price: "100"),stuteacher(image: "teaPro_03.JPG", school: "电子科技大学", name: "陈老师", gender: "女", old: "20岁", major: "计算机科学", degree: "研究生", teaOld: "37", price: "100")]
        return teachers
    }()
...
//
//            //set detail
        let cell:OrderedTableViewCell = Bundle.main.loadNibNamed("OrderedTableViewCell", owner:nil,  options:nil)?.first as! OrderedTableViewCell
...
extension OrderViewController1{
