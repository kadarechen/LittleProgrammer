...
class XYXFilterView: UIView {
    ...
    private let collectionView:UICollectionView = {
        ...
        collectionView.register(XYXFilterDefaultHeaderView.classForCoder(), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: XYXFilterDefaultHeaderView.reuseIdentifier())
        collectionView.register(XYXFilterDefaultFooterView.classForCoder(), forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: XYXFilterDefaultFooterView.reuseIdentifier())
...
extension XYXFilterView:UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell == nil {
//            cell = XYXFilterViewTableViewCell.init(coder: <#NSCoder#>, style: .default, reuseIdentifier: XYXFilterViewTableViewCell.reuseIdentifier())
...
extension XYXFilterView:UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader:
            let headerView = collectionView.dequeueReusableSupplementaryView(ofKind:UICollectionView.elementKindSectionHeader,  withReuseIdentifier: XYXFilterDefaultHeaderView.reuseIdentifier(), for: indexPath) as! XYXFilterDefaultHeaderView
            var title = "未定义"
        ...
        case UICollectionView.elementKindSectionFooter:
            let footerView = collectionView.dequeueReusableSupplementaryView(ofKind:UICollectionView.elementKindSectionFooter,  withReuseIdentifier: XYXFilterDefaultFooterView.reuseIdentifier(), for: indexPath)
            return footerView
...
extension XYXFilterView{
    ...
    func submitResult() {
        print("提交筛选结果")
        print("table:\((menu?.selectedTableViewIndexPaths)!)")
//        print(type(of: (menu?.selectedTableViewIndexPaths)!))
        ...
        (theViewControllerYouSee as! TeacherViewController).updateTable(table: (menu?.selectedTableViewIndexPaths)!, collection: (menu?.selectedCollectionViewIndexPaths)!)
    }
}
